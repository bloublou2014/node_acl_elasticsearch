    ...
    getAll: function (bucket, cb) {
        ...
        this.client.search(
            ...
            function (error, response) {
                ...
                let result = {};
                _.each(response.hits.hits, function (doc) {
                    result[doc._id] = fixKeysInArray(_.keys(doc._source));
                });
    ...
    union: function (bucket, keys, cb) {
        ...
        this.client.mget(
            ...
            function (err, resp) {
                ...
                let pluckArray = _.compact(_.map(resp.docs, "_source"));
